/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/cbuild/slaves/oorts/crosstool-ng/builds/aarch64-none-elf-linux/.build/src/gcc-linaro-4.9-2014.09/gcc/config/aarch64/aarch64.md'.  */
